...
Renders in terminal this is default behaviour

## SSG - Static Side Generation
Any page that has content which does not have network calls is called static page by default

## ISG / ISR - Incremental Side Genration 
